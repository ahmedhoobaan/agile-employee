...
<div style="margin-top:50px;background-color:darkcyan;margin-left:300px;margin-right:300px">
    <form action="trans_insert.php" method="POST" class="container" id="needs-validation" novalidate>
        <div class="row">
            ...
            <div class="col-md-8 mb-3" style="padding-left: 80px">
                <label for="second_name">Transfer Date </label>
                <input type="date" name="Transfer_date"  class="form-control" id="Transfer_date" placeholder="Transfer date"   required>
            </div>




            <!--departments transfer to deparments  -->
            <div class="col-md-8 mb-3"  style="padding-left:80px">
                <label for=trans_departement">Transfer To (Department)</label>
                  <select name="Transfer_Department" id="Transfer_Department" class="form-control" style=" #trans_departement:hover; background-color: blanchedalmond;">
            ...
            <div class="col-md-8 mb-3"  style="padding-left:80px">
                <label for=trans_departement">Transfer To (Station):</label>
                <select name="Transfer_station" id="trans_Station" class="form-control" style=" #trans_departement:hover; background-color: blanchedalmond;">
